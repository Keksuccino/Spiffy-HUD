...
import de.keksuccino.fancyhud.customization.helper.ui.screens.FHConfigScreen;
...
public class MenuBar extends UIBase {
	...
	public static final ResourceLocation FH_LOGO_TEXTURE = new ResourceLocation("fancyhud", "fh_pixel_logo.png");
	public static final ResourceLocation SHRINK_BTN_TEXTURE = new ResourceLocation("fancyhud", "shrink_btn.png");
	public static final ResourceLocation EXPAND_BTN_TEXTURE = new ResourceLocation("fancyhud", "expand_btn.png");
	...
	public MenuBar() {
		...
		fhBtn.setDescription(StringUtils.splitLines(Locals.localize("fancyhud.config"), "%n%"));
		...
		AdvancedButton expandBtn = new AdvancedImageButton(0, 0, 20, 20, SHRINK_BTN_TEXTURE, true, (press) -> {
			...
			if (this.expanded) {
				...
				((AdvancedButton)press).setDescription(Locals.localize("fancyhud.helper.menubar.shrink"));
			} else {
				((AdvancedImageButton)press).setImage(EXPAND_BTN_TEXTURE);
				((AdvancedButton)press).setDescription(Locals.localize("fancyhud.helper.menubar.expand"));
			}
		}) {
			@Override
			public void render(MatrixStack matrix, int mouseX, int mouseY, float partialTicks) {
		...
		expandBtn.setDescription(Locals.localize("fancyhud.helper.menubar.shrink"));
