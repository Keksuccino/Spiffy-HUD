...
public class SidebarLayoutElement extends VanillaLayoutElement {
	...
	public void init() {
		...
		/** HEADLINE BACK COLOR **/
		AdvancedButton headlineBackColorButton = new AdvancedButton(0, 0, 0, 0, Locals.localize("fancyhud.helper.editor.elements.vanilla.sidebar.headlinebackcolor"), (press) -> {
			FHTextInputPopup pop = new FHTextInputPopup(new Color(0, 0, 0, 0), Locals.localize("fancyhud.helper.editor.elements.vanilla.sidebar.headlinebackcolor"), null, 240, (call) -> {
				if (call != null) {
		...
		/** BODY BACK COLOR **/
		AdvancedButton bodyBackColorButton = new AdvancedButton(0, 0, 0, 0, Locals.localize("fancyhud.helper.editor.elements.vanilla.sidebar.bodybackcolor"), (press) -> {
			FHTextInputPopup pop = new FHTextInputPopup(new Color(0, 0, 0, 0), Locals.localize("fancyhud.helper.editor.elements.vanilla.sidebar.bodybackcolor"), null, 240, (call) -> {
				if (call != null) {
		...
		/** HEADLINE TEXT COLOR **/
		AdvancedButton headlineTextColorButton = new AdvancedButton(0, 0, 0, 0, Locals.localize("fancyhud.helper.editor.elements.vanilla.sidebar.headlinetextcolor"), (press) -> {
			FHTextInputPopup pop = new FHTextInputPopup(new Color(0, 0, 0, 0), Locals.localize("fancyhud.helper.editor.elements.vanilla.sidebar.headlinetextcolor"), null, 240, (call) -> {
				if (call != null) {
		...
		/** NAME TEXT COLOR **/
		AdvancedButton nameTextColorButton = new AdvancedButton(0, 0, 0, 0, Locals.localize("fancyhud.helper.editor.elements.vanilla.sidebar.nametextcolor"), (press) -> {
			FHTextInputPopup pop = new FHTextInputPopup(new Color(0, 0, 0, 0), Locals.localize("fancyhud.helper.editor.elements.vanilla.sidebar.nametextcolor"), null, 240, (call) -> {
				if (call != null) {
		...
		/** SCORE TEXT COLOR **/
		AdvancedButton scoreTextColorButton = new AdvancedButton(0, 0, 0, 0, Locals.localize("fancyhud.helper.editor.elements.vanilla.sidebar.scoretextcolor"), (press) -> {
			FHTextInputPopup pop = new FHTextInputPopup(new Color(0, 0, 0, 0), Locals.localize("fancyhud.helper.editor.elements.vanilla.sidebar.scoretextcolor"), null, 240, (call) -> {
				if (call != null) {
