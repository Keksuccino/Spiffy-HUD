...
public class ChooseFilePopup extends FHTextInputPopup {
	...
	public ChooseFilePopup(Consumer<String> callback, String... fileTypes) {
		super(new Color(0, 0, 0, 0), Locals.localize("fancyhud.helper.creator.choosefile.enterorchoose"), null, 0, callback);
	...
	protected void init(Color color, String title, CharacterFilter filter, Consumer<String> callback) {
		...
		this.chooseFileBtn = new AdvancedButton(0, 0, 100, 20, Locals.localize("fancyhud.helper.creator.choosefile.choose"), true, (press) -> {
