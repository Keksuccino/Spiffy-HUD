...
public abstract class LayoutElement extends AbstractGui {
	...
	public void init() {
		...
		AdvancedButton orientationButton = new AdvancedButton(0, 0, 0, 0, Locals.localize("fancyhud.helper.creator.items.setorientation"), true, (press) -> {
		...
		stretchXButton = new AdvancedButton(0, 0, 0, 0, Locals.localize("fancyhud.helper.creator.object.stretch.x"), true, (press) -> {
			if (this.stretchX) {
		...
		stretchYButton = new AdvancedButton(0, 0, 0, 0, Locals.localize("fancyhud.helper.creator.object.stretch.y"), true, (press) -> {
			if (this.stretchY) {
		...
		AdvancedButton stretchButton = new AdvancedButton(0, 0, 0, 0, Locals.localize("fancyhud.helper.creator.object.stretch"), true, (press) -> {
		...
		/** MOVE UP **/
		AdvancedButton moveUpButton = new AdvancedButton(0, 0, 0, 0, Locals.localize("fancyhud.helper.creator.object.moveup"), (press) -> {
			LayoutElement o = this.handler.moveUp(this);
			if (o != null) {
				((AdvancedButton)press).setDescription(StringUtils.splitLines(Locals.localize("fancyhud.helper.creator.object.moveup.desc", Locals.localize("fancyhud.helper.creator.object.moveup.desc.subtext", o.object.value)), "%n%"));
			}
		});
		moveUpButton.setDescription(StringUtils.splitLines(Locals.localize("fancyhud.helper.creator.object.moveup.desc", ""), "%n%"));
		if (this.orderable) {
			this.rightclickMenu.addContent(moveUpButton);
		}

		/** MOVE DOWN **/
		AdvancedButton moveDownButton = new AdvancedButton(0, 0, 0, 0, Locals.localize("fancyhud.helper.creator.object.movedown"), (press) -> {
			LayoutElement o = this.handler.moveDown(this);
			if (o != null) {
				if (o.isVanillaElement()) {
					((AdvancedButton)press).setDescription(StringUtils.splitLines(Locals.localize("fancyhud.helper.creator.object.movedown.desc", Locals.localize("fancyhud.helper.creator.object.movedown.desc.subtext.vanillabutton")), "%n%"));
				} else {
					((AdvancedButton)press).setDescription(StringUtils.splitLines(Locals.localize("fancyhud.helper.creator.object.movedown.desc", Locals.localize("fancyhud.helper.creator.object.movedown.desc.subtext", o.object.value)), "%n%"));
				}
			}
		});
		moveDownButton.setDescription(StringUtils.splitLines(Locals.localize("fancyhud.helper.creator.object.movedown.desc", ""), "%n%"));
		if (this.orderable) {
		...
		/** DESTROY **/
		AdvancedButton destroyButton = new AdvancedButton(0, 0, 0, 0, Locals.localize("fancyhud.helper.creator.items.delete"), true, (press) -> {
			this.destroyObject();
		});
		if (this.destroyable) {
	...
	public void setStretchedX(boolean b, boolean saveSnapshot) {
		if (this.isOrientationSupportedByStretchAction(b, this.stretchY)) {
			...
			this.stretchX = b;
			String stretchXLabel = Locals.localize("fancyhud.helper.creator.object.stretch.x");
			if (this.stretchX) {
	...
	public void setStretchedY(boolean b, boolean saveSnapshot) {
		if (this.isOrientationSupportedByStretchAction(this.stretchX, b)) {
			...
			this.stretchY = b;
			String stretchYLabel = Locals.localize("fancyhud.helper.creator.object.stretch.y");
			if (this.stretchY) {
		...
		try {
			if (stX && !stY) {
				if (!this.object.orientation.equals("top-left") && !this.object.orientation.equals("mid-left") && !this.object.orientation.equals("bottom-left")) {
					LayoutEditorScreen.displayNotification(Locals.localize("fancyhud.helper.creator.object.stretch.unsupportedorientation", "top-left, mid-left, bottom-left"));
					return false;
				}
			}
			if (stY && !stX) {
				if (!this.object.orientation.equals("top-left") && !this.object.orientation.equals("top-centered") && !this.object.orientation.equals("top-right")) {
					LayoutEditorScreen.displayNotification(Locals.localize("fancyhud.helper.creator.object.stretch.unsupportedorientation", "top-left, top-centered, top-right"));
					return false;
				}
			}
			if (stX && stY) {
				if (!this.object.orientation.equals("top-left")) {
					LayoutEditorScreen.displayNotification(Locals.localize("fancyhud.helper.creator.object.stretch.unsupportedorientation", "top-left"));
					return false;
				}
			}
			return true;
	...
	protected void renderBorder(MatrixStack matrix, int mouseX, int mouseY) {
		...
		AbstractGui.drawString(matrix, Minecraft.getInstance().fontRenderer, Locals.localize("fancyhud.helper.creator.items.border.orientation") + ": " + this.object.orientation, this.object.getPosX()*2, (this.object.getPosY()*2) - 26, Color.WHITE.getRGB());
		AbstractGui.drawString(matrix, Minecraft.getInstance().fontRenderer, Locals.localize("fancyhud.helper.creator.items.border.posx") + ": " + this.object.getPosX(), this.object.getPosX()*2, (this.object.getPosY()*2) - 17, Color.WHITE.getRGB());
		AbstractGui.drawString(matrix, Minecraft.getInstance().fontRenderer, Locals.localize("fancyhud.helper.creator.items.border.width") + ": " + this.object.width, this.object.getPosX()*2, (this.object.getPosY()*2) - 8, Color.WHITE.getRGB());
		
		AbstractGui.drawString(matrix, Minecraft.getInstance().fontRenderer, Locals.localize("fancyhud.helper.creator.items.border.posy") + ": " + this.object.getPosY(), ((this.object.getPosX() + this.object.width)*2)+3, ((this.object.getPosY() + this.object.height)*2) - 14, Color.WHITE.getRGB());
		AbstractGui.drawString(matrix, Minecraft.getInstance().fontRenderer, Locals.localize("fancyhud.helper.creator.items.border.height") + ": " + this.object.height, ((this.object.getPosX() + this.object.width)*2)+3, ((this.object.getPosY() + this.object.height)*2) - 5, Color.WHITE.getRGB());
	...
	public void destroyObject() {
		...
		if (FancyHud.config.getOrDefault("editordeleteconfirmation", true)) {
			PopupHandler.displayPopup(new FHYesNoPopup(300, new Color(0, 0, 0, 0), 240, (call) -> {
				if (call) {
					this.handler.deleteContentQueue.add(this);
				}
			}, "§c§l" + Locals.localize("fancyhud.helper.creator.messages.sure"), "", Locals.localize("fancyhud.helper.creator.deleteobject"), "", "", "", "", ""));
		} else {
			this.handler.deleteContentQueue.add(this);
		}
	}
