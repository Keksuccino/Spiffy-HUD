package de.keksuccino.fancyhud.customization.helper.ui.content;
...
public class DynamicValueTextfield extends AdvancedTextField {
	...
	private static final ResourceLocation VARIABLES_BUTTON_RESOURCE = new ResourceLocation("fancyhud", "add_btn.png");
	...
	public DynamicValueTextfield(FontRenderer fontrenderer, int x, int y, int width, int height, boolean handleTextField, CharacterFilter filter) {
		...
		AdvancedButton playerName = new AdvancedButton(0, 0, 0, 0, Locals.localize("fancyhud.helper.ui.dynamicvariabletextfield.variables.playername"), true, (press) -> {
			this.writeText("%playername%");
		});
		playerName.setDescription(StringUtils.splitLines(Locals.localize("fancyhud.helper.ui.dynamicvariabletextfield.variables.playername.desc"), "%n%"));
		UIBase.colorizeButton(playerName);
		playerMenu.addContent(playerName);
		
		AdvancedButton playerUUID = new AdvancedButton(0, 0, 0, 0, Locals.localize("fancyhud.helper.ui.dynamicvariabletextfield.variables.playeruuid"), true, (press) -> {
			this.writeText("%playeruuid%");
		});
		playerUUID.setDescription(StringUtils.splitLines(Locals.localize("fancyhud.helper.ui.dynamicvariabletextfield.variables.playeruuid.desc"), "%n%"));
		UIBase.colorizeButton(playerUUID);
		playerMenu.addContent(playerUUID);
		
		playerMenu.addSeparator();
		
		AdvancedButton currentHealth = new AdvancedButton(0, 0, 0, 0, Locals.localize("fancyhud.helper.ui.dynamicvariabletextfield.variables.currenthealth"), true, (press) -> {
			this.writeText("%currenthealth%");
		});
		UIBase.colorizeButton(currentHealth);
		playerMenu.addContent(currentHealth);
		
		AdvancedButton maxHealth = new AdvancedButton(0, 0, 0, 0, Locals.localize("fancyhud.helper.ui.dynamicvariabletextfield.variables.maxhealth"), true, (press) -> {
			this.writeText("%maxhealth%");
		});
		UIBase.colorizeButton(maxHealth);
		playerMenu.addContent(maxHealth);
		
		AdvancedButton currentFood = new AdvancedButton(0, 0, 0, 0, Locals.localize("fancyhud.helper.ui.dynamicvariabletextfield.variables.currentfood"), true, (press) -> {
			this.writeText("%currentfood%");
		});
		UIBase.colorizeButton(currentFood);
		playerMenu.addContent(currentFood);
		
		AdvancedButton currentAir = new AdvancedButton(0, 0, 0, 0, Locals.localize("fancyhud.helper.ui.dynamicvariabletextfield.variables.currentair"), true, (press) -> {
			this.writeText("%currentair%");
		});
		UIBase.colorizeButton(currentAir);
		playerMenu.addContent(currentAir);
		
		AdvancedButton maxAir = new AdvancedButton(0, 0, 0, 0, Locals.localize("fancyhud.helper.ui.dynamicvariabletextfield.variables.maxair"), true, (press) -> {
			this.writeText("%maxair%");
		});
		UIBase.colorizeButton(maxAir);
		playerMenu.addContent(maxAir);
		
		AdvancedButton currentArmor = new AdvancedButton(0, 0, 0, 0, Locals.localize("fancyhud.helper.ui.dynamicvariabletextfield.variables.currentarmor"), true, (press) -> {
			this.writeText("%currentarmor%");
		});
		UIBase.colorizeButton(currentArmor);
		playerMenu.addContent(currentArmor);
		
		AdvancedButton currentScore = new AdvancedButton(0, 0, 0, 0, Locals.localize("fancyhud.helper.ui.dynamicvariabletextfield.variables.currentscore"), true, (press) -> {
		...
		AdvancedButton posX = new AdvancedButton(0, 0, 0, 0, Locals.localize("fancyhud.helper.ui.dynamicvariabletextfield.variables.posx"), true, (press) -> {
			this.writeText("%posx%");
		});
		UIBase.colorizeButton(posX);
		playerMenu.addContent(posX);
		
		AdvancedButton posY = new AdvancedButton(0, 0, 0, 0, Locals.localize("fancyhud.helper.ui.dynamicvariabletextfield.variables.posy"), true, (press) -> {
			this.writeText("%posy%");
		});
		UIBase.colorizeButton(posY);
		playerMenu.addContent(posY);
		
		AdvancedButton posZ = new AdvancedButton(0, 0, 0, 0, Locals.localize("fancyhud.helper.ui.dynamicvariabletextfield.variables.posz"), true, (press) -> {
			this.writeText("%posz%");
		});
		...
		AdvancedButton level = new AdvancedButton(0, 0, 0, 0, Locals.localize("fancyhud.helper.ui.dynamicvariabletextfield.variables.level"), true, (press) -> {
		...
		AdvancedButton mainhandName = new AdvancedButton(0, 0, 0, 0, Locals.localize("fancyhud.helper.ui.dynamicvariabletextfield.variables.mhitemname"), true, (press) -> {
			this.writeText("%mhitemname%");
		});
		UIBase.colorizeButton(mainhandName);
		playerMenu.addContent(mainhandName);
		
		AdvancedButton mainhandCurDurab = new AdvancedButton(0, 0, 0, 0, Locals.localize("fancyhud.helper.ui.dynamicvariabletextfield.variables.mhitemcurdurab"), true, (press) -> {
			this.writeText("%mhitemcurdurab%");
		});
		UIBase.colorizeButton(mainhandCurDurab);
		playerMenu.addContent(mainhandCurDurab);
		
		AdvancedButton mainhandMaxDurab = new AdvancedButton(0, 0, 0, 0, Locals.localize("fancyhud.helper.ui.dynamicvariabletextfield.variables.mhitemmaxdurab"), true, (press) -> {
		...
		AdvancedButton offhandName = new AdvancedButton(0, 0, 0, 0, Locals.localize("fancyhud.helper.ui.dynamicvariabletextfield.variables.ohitemname"), true, (press) -> {
			this.writeText("%ohitemname%");
		});
		UIBase.colorizeButton(offhandName);
		playerMenu.addContent(offhandName);
		
		AdvancedButton offhandCurDurab = new AdvancedButton(0, 0, 0, 0, Locals.localize("fancyhud.helper.ui.dynamicvariabletextfield.variables.ohitemcurdurab"), true, (press) -> {
			this.writeText("%ohitemcurdurab%");
		});
		UIBase.colorizeButton(offhandCurDurab);
		playerMenu.addContent(offhandCurDurab);
		
		AdvancedButton offhandMaxDurab = new AdvancedButton(0, 0, 0, 0, Locals.localize("fancyhud.helper.ui.dynamicvariabletextfield.variables.ohitemmaxdurab"), true, (press) -> {
			this.writeText("%ohitemmaxdurab%");
		});
		UIBase.colorizeButton(offhandMaxDurab);
		playerMenu.addContent(offhandMaxDurab);
		
		AdvancedButton playerCategoryButton = new AdvancedButton(0, 0, 0, 0, Locals.localize("fancyhud.helper.ui.dynamicvariabletextfield.categories.player"), true, (press) -> {
		...
		AdvancedButton serverIp = new AdvancedButton(0, 0, 0, 0, Locals.localize("fancyhud.helper.ui.dynamicvariabletextfield.variables.serverip"), true, (press) -> {
			this.writeText("%serverip%");
		});
		UIBase.colorizeButton(serverIp);
		serverMenu.addContent(serverIp);
		
		AdvancedButton serverMotd = new AdvancedButton(0, 0, 0, 0, Locals.localize("fancyhud.helper.ui.dynamicvariabletextfield.variables.servermotd"), true, (press) -> {
			this.writeText("%servermotd%");
		});
		UIBase.colorizeButton(serverMotd);
		serverMenu.addContent(serverMotd);
		
		AdvancedButton serverPing = new AdvancedButton(0, 0, 0, 0, Locals.localize("fancyhud.helper.ui.dynamicvariabletextfield.variables.serverping"), true, (press) -> {
			this.writeText("%serverping%");
		});
		UIBase.colorizeButton(serverPing);
		serverMenu.addContent(serverPing);
		
		AdvancedButton serverPlayers = new AdvancedButton(0, 0, 0, 0, Locals.localize("fancyhud.helper.ui.dynamicvariabletextfield.variables.serverplayers"), true, (press) -> {
			this.writeText("%serverplayers%");
		});
		UIBase.colorizeButton(serverPlayers);
		serverMenu.addContent(serverPlayers);
		
		AdvancedButton serverMods = new AdvancedButton(0, 0, 0, 0, Locals.localize("fancyhud.helper.ui.dynamicvariabletextfield.variables.servermods"), true, (press) -> {
			this.writeText("%servermods%");
		});
		UIBase.colorizeButton(serverMods);
		serverMenu.addContent(serverMods);
		
		AdvancedButton serverCategoryButton = new AdvancedButton(0, 0, 0, 0, Locals.localize("fancyhud.helper.ui.dynamicvariabletextfield.categories.server"), true, (press) -> {
		...
		AdvancedButton gameDaytimeHours = new AdvancedButton(0, 0, 0, 0, Locals.localize("fancyhud.helper.ui.dynamicvariabletextfield.variables.daytimehours"), true, (press) -> {
			this.writeText("%daytimehours%");
		});
		UIBase.colorizeButton(gameDaytimeHours);
		worldMenu.addContent(gameDaytimeHours);
		
		AdvancedButton gameDaytimeMinutes = new AdvancedButton(0, 0, 0, 0, Locals.localize("fancyhud.helper.ui.dynamicvariabletextfield.variables.daytimeminutes"), true, (press) -> {
			this.writeText("%daytimeminutes%");
		});
		UIBase.colorizeButton(gameDaytimeMinutes);
		worldMenu.addContent(gameDaytimeMinutes);
		
		AdvancedButton worldCategoryButton = new AdvancedButton(0, 0, 0, 0, Locals.localize("fancyhud.helper.ui.dynamicvariabletextfield.categories.world"), true, (press) -> {
		...
		AdvancedButton realtimeYear = new AdvancedButton(0, 0, 0, 0, Locals.localize("fancyhud.helper.ui.dynamicvariabletextfield.variables.realtimeyear"), true, (press) -> {
			this.writeText("%realtimeyear%");
		});
		UIBase.colorizeButton(realtimeYear);
		realtimeMenu.addContent(realtimeYear);
		
		AdvancedButton realtimeMonth = new AdvancedButton(0, 0, 0, 0, Locals.localize("fancyhud.helper.ui.dynamicvariabletextfield.variables.realtimemonth"), true, (press) -> {
			this.writeText("%realtimemonth%");
		});
		UIBase.colorizeButton(realtimeMonth);
		realtimeMenu.addContent(realtimeMonth);
		
		AdvancedButton realtimeDay = new AdvancedButton(0, 0, 0, 0, Locals.localize("fancyhud.helper.ui.dynamicvariabletextfield.variables.realtimeday"), true, (press) -> {
			this.writeText("%realtimeday%");
		});
		UIBase.colorizeButton(realtimeDay);
		realtimeMenu.addContent(realtimeDay);
		
		AdvancedButton realtimeHour = new AdvancedButton(0, 0, 0, 0, Locals.localize("fancyhud.helper.ui.dynamicvariabletextfield.variables.realtimehour"), true, (press) -> {
			this.writeText("%realtimehour%");
		});
		UIBase.colorizeButton(realtimeHour);
		realtimeMenu.addContent(realtimeHour);
		
		AdvancedButton realtimeMinute = new AdvancedButton(0, 0, 0, 0, Locals.localize("fancyhud.helper.ui.dynamicvariabletextfield.variables.realtimeminute"), true, (press) -> {
			this.writeText("%realtimeminute%");
		});
		UIBase.colorizeButton(realtimeMinute);
		realtimeMenu.addContent(realtimeMinute);
		
		AdvancedButton realtimeSecond = new AdvancedButton(0, 0, 0, 0, Locals.localize("fancyhud.helper.ui.dynamicvariabletextfield.variables.realtimesecond"), true, (press) -> {
			this.writeText("%realtimesecond%");
		});
		UIBase.colorizeButton(realtimeSecond);
		realtimeMenu.addContent(realtimeSecond);
		
		AdvancedButton realtimeCategoryButton = new AdvancedButton(0, 0, 0, 0, Locals.localize("fancyhud.helper.ui.dynamicvariabletextfield.categories.realtime"), true, (press) -> {
		...
		AdvancedButton mcVersion = new AdvancedButton(0, 0, 0, 0, Locals.localize("fancyhud.helper.ui.dynamicvariabletextfield.variables.mcversion"), true, (press) -> {
			this.writeText("%mcversion%");
		});
		mcVersion.setDescription(StringUtils.splitLines(Locals.localize("fancyhud.helper.ui.dynamicvariabletextfield.variables.mcversion.desc"), "%n%"));
		UIBase.colorizeButton(mcVersion);
		otherMenu.addContent(mcVersion);
		
		AdvancedButton forgeVersion = new AdvancedButton(0, 0, 0, 0, Locals.localize("fancyhud.helper.ui.dynamicvariabletextfield.variables.forgeversion"), true, (press) -> {
			this.writeText("%version:forge%");
		});
		forgeVersion.setDescription(StringUtils.splitLines(Locals.localize("fancyhud.helper.ui.dynamicvariabletextfield.variables.forgeversion.desc"), "%n%"));
		UIBase.colorizeButton(forgeVersion);
		otherMenu.addContent(forgeVersion);
		
		AdvancedButton modVersion = new AdvancedButton(0, 0, 0, 0, Locals.localize("fancyhud.helper.ui.dynamicvariabletextfield.variables.modversion"), true, (press) -> {
			this.writeText("%version:<modid>%");
		});
		modVersion.setDescription(StringUtils.splitLines(Locals.localize("fancyhud.helper.ui.dynamicvariabletextfield.variables.modversion.desc"), "%n%"));
		UIBase.colorizeButton(modVersion);
		otherMenu.addContent(modVersion);
		
		AdvancedButton totalMods = new AdvancedButton(0, 0, 0, 0, Locals.localize("fancyhud.helper.ui.dynamicvariabletextfield.variables.totalmods"), true, (press) -> {
			this.writeText("%totalmods%");
		});
		totalMods.setDescription(StringUtils.splitLines(Locals.localize("fancyhud.helper.ui.dynamicvariabletextfield.variables.totalmods.desc"), "%n%"));
		UIBase.colorizeButton(totalMods);
		otherMenu.addContent(totalMods);
		
		AdvancedButton loadedMods = new AdvancedButton(0, 0, 0, 0, Locals.localize("fancyhud.helper.ui.dynamicvariabletextfield.variables.loadedmods"), true, (press) -> {
		...
		AdvancedButton otherCategoryButton = new AdvancedButton(0, 0, 0, 0, Locals.localize("fancyhud.helper.ui.dynamicvariabletextfield.categories.other"), true, (press) -> {
		...
		variableButton.setDescription(StringUtils.splitLines(Locals.localize("fancyhud.helper.ui.dynamicvariabletextfield.variables.desc"), "%n%"));
