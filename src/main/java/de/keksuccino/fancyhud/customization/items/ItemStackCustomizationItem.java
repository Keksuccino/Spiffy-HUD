...
public class ItemStackCustomizationItem extends CustomizationItemBase {
    ...
    protected static final ResourceLocation SLOT_PLACEHOLDER = new ResourceLocation("fancyhud", "helper/slot_placeholder.png");
    protected static final ResourceLocation MISSING_ITEM = new ResourceLocation("fancyhud", "helper/missing_element.png");
