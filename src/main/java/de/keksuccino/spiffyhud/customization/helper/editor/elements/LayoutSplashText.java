...
public class LayoutSplashText extends LayoutElement {
	...
	protected void renderBorder(PoseStack matrix, int mouseX, int mouseY) {
		...
		drawString(matrix, Minecraft.getInstance().font, Locals.localize("spiffyhud.helper.creator.items.border.orientation") + ": " + this.object.orientation, this.object.getPosX()*2, (this.object.getPosY()*2) - 26, Color.WHITE.getRGB());
		drawString(matrix, Minecraft.getInstance().font, Locals.localize("spiffyhud.helper.creator.items.border.posx") + ": " + this.object.getPosX(), this.object.getPosX()*2, (this.object.getPosY()*2) - 17, Color.WHITE.getRGB());
		drawString(matrix, Minecraft.getInstance().font, Locals.localize("spiffyhud.helper.creator.items.border.width") + ": " + this.object.width, this.object.getPosX()*2, (this.object.getPosY()*2) - 8, Color.WHITE.getRGB());
		
		drawString(matrix, Minecraft.getInstance().font, Locals.localize("spiffyhud.helper.creator.items.border.posy") + ": " + this.object.getPosY(), ((this.object.getPosX() + this.object.width)*2)+3, ((this.object.getPosY() + this.object.height)*2) - 14, Color.WHITE.getRGB());
		drawString(matrix, Minecraft.getInstance().font, Locals.localize("spiffyhud.helper.creator.items.border.height") + ": " + this.object.height, ((this.object.getPosX() + this.object.width)*2)+3, ((this.object.getPosY() + this.object.height)*2) - 5, Color.WHITE.getRGB());
