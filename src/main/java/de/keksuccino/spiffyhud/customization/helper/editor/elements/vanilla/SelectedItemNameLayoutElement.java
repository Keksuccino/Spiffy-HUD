...
//		
//		/** BASE COLOR **/
//		AdvancedButton lvlColorButton = new AdvancedButton(0, 0, 0, 0, Locals.localize("spiffyhud.helper.editor.elements.vanilla.selecteditemname.color"), (press) -> {
//			FHTextInputPopup pop = new FHTextInputPopup(new Color(0, 0, 0, 0), Locals.localize("spiffyhud.helper.editor.elements.vanilla.selecteditemname.color"), null, 240, (call) -> {
//				if (call != ob.colorHex) {
...
//		});
//		lvlColorButton.setDescription(StringUtils.splitLines(Locals.localize("spiffyhud.helper.editor.elements.vanilla.selecteditemname.color.desc", ""), "%n%"));
