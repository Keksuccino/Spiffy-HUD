...
public class ArmorBarLayoutElement extends VanillaLayoutElement {
	...
	public void init() {
		...
		/** HIDE WHEN EMPTY **/
		String hideFullString = Locals.localize("spiffyhud.helper.editor.elements.vanilla.bars.hidewhenempty.on");
		if (!((ArmorBarCustomizationItem)this.getVanillaObject()).hideWhenEmpty) {
			hideFullString = Locals.localize("spiffyhud.helper.editor.elements.vanilla.bars.hidewhenempty.off");
		}
		...
		hideWhenFullButton.setDescription(StringUtils.splitLines(Locals.localize("spiffyhud.helper.editor.elements.vanilla.bars.hidewhenempty.btn.desc"), "%n%"));
