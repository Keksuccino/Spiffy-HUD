...
//        String rotatePlayerLabel = Locals.localize("spiffyhud.helper.creator.items.mirroredplayer.rotateplayer.on");
//        if (!this.getObject().autoRotatePlayer) {
//            rotatePlayerLabel = Locals.localize("spiffyhud.helper.creator.items.mirroredplayer.rotateplayer.off");
//        }
//        AdvancedButton rotatePlayerButton = new AdvancedButton(0, 0, 0, 16, rotatePlayerLabel, true, (press) -> {
//            if (this.getObject().autoRotatePlayer) {
//                ((AdvancedButton)press).setMessage(Locals.localize("spiffyhud.helper.creator.items.mirroredplayer.rotateplayer.off"));
//                this.getObject().autoRotatePlayer = false;
//            } else {
//                ((AdvancedButton)press).setMessage(Locals.localize("spiffyhud.helper.creator.items.mirroredplayer.rotateplayer.on"));
