...
public class LayoutEditorUI extends UIBase {
	...
	protected static final Identifier CLOSE_BUTTON_TEXTURE = new Identifier("spiffyhud", "close_btn.png");
			...
			if (this.parent.isObjectFocused()) {
				...
				AdvancedButton stretchXBtn = new AdvancedButton(0, 0, 0, 16, Locals.localize("spiffyhud.helper.creator.object.stretch.x"), true, (press) -> {
					...
					if (!this.parent.multiselectStretchedX) {
						press.setMessage(new LiteralText(Locals.localize("spiffyhud.helper.creator.object.stretch.x")));
					} else {
						press.setMessage(new LiteralText("§a" + Locals.localize("spiffyhud.helper.creator.object.stretch.x")));
					}
				...
				AdvancedButton stretchYBtn = new AdvancedButton(0, 0, 0, 16, Locals.localize("spiffyhud.helper.creator.object.stretch.y"), true, (press) -> {
					...
					if (!this.parent.multiselectStretchedY) {
						press.setMessage(new LiteralText(Locals.localize("spiffyhud.helper.creator.object.stretch.y")));
					} else {
						press.setMessage(new LiteralText("§a" + Locals.localize("spiffyhud.helper.creator.object.stretch.y")));
					}
