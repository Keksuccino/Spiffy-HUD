			...
			if (this.parent.isObjectFocused()) {
				...
				AdvancedButton stretchXBtn = new AdvancedButton(0, 0, 0, 16, Locals.localize("spiffyhud.helper.creator.object.stretch.x"), true, (press) -> {
					...
					if (!this.parent.multiselectStretchedX) {
						press.setMessage(new TextComponent(Locals.localize("spiffyhud.helper.creator.object.stretch.x")));
					} else {
						press.setMessage(new TextComponent("§a" + Locals.localize("spiffyhud.helper.creator.object.stretch.x")));
					}
				...
				AdvancedButton stretchYBtn = new AdvancedButton(0, 0, 0, 16, Locals.localize("spiffyhud.helper.creator.object.stretch.y"), true, (press) -> {
					...
					if (!this.parent.multiselectStretchedY) {
						press.setMessage(new TextComponent(Locals.localize("spiffyhud.helper.creator.object.stretch.y")));
					} else {
						press.setMessage(new TextComponent("§a" + Locals.localize("spiffyhud.helper.creator.object.stretch.y")));
					}
