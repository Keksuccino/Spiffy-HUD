...
public class SetRainbowStringColorPopup extends Popup {
	...
	public void render(MatrixStack matrix, int mouseX, int mouseY, Screen renderIn) {
		...
		if (this.isDisplayed()) {
			...
			/** DESCRIPTION **/
			String line1 = TextFormatting.GRAY + Locals.localize("spiffyhud.helper.editor.elements.string.rainbow.colors.popup.colordesc.line1");
			...
			String line2 = TextFormatting.GRAY + Locals.localize("spiffyhud.helper.editor.elements.string.rainbow.colors.popup.colordesc.line2");
			...
			String line3 = TextFormatting.GRAY + Locals.localize("spiffyhud.helper.editor.elements.string.rainbow.colors.popup.colordesc.line3");
