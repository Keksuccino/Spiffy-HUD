...
import de.keksuccino.spiffyhud.customization.items.custombars.CustomAirBarCustomizationItem;
import de.keksuccino.konkrete.gui.content.AdvancedButton;
import de.keksuccino.konkrete.input.StringUtils;
import de.keksuccino.konkrete.localization.Locals;
import de.keksuccino.konkrete.properties.PropertiesSection;

public class LayoutCustomAirBar extends LayoutCustomBarBase {

	public LayoutCustomAirBar(CustomAirBarCustomizationItem object, LayoutEditorScreen handler) {
	...
	public void init() {
		...
		CustomAirBarCustomizationItem i = (CustomAirBarCustomizationItem) this.getObject();
	...
	protected PropertiesSection getPropertiesRaw() {
		...
		s.addEntry("action", "addcustomairbar");
		s.addEntry("hidewhenfull", "" + ((CustomAirBarCustomizationItem)this.getObject()).hideWhenFull);
		return s;
	}
