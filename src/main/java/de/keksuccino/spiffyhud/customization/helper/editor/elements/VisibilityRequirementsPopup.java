...
public class VisibilityRequirementsPopup extends FHPopup {
    ...
    public static class Requirement extends DrawableHelper {
        ...
        public Requirement(VisibilityRequirementsPopup parent, String name, String desc, String valueName, boolean enabled, boolean showIf, Consumer<Boolean> enabledCallback, Consumer<Boolean> showIfCallback, Consumer<String> valueCallback, CharacterFilter valueFilter, String valueString) {
            this.parent = parent;
            this.name = name;
            this.desc = desc;
        ...
        public void render(MatrixStack matrix, int mouseX, int mouseY, Screen renderIn) {
            ...
            drawCenteredText(matrix, MinecraftClient.getInstance().textRenderer, Locals.localize("spiffyhud.helper.creator.items.visibilityrequirements.requirement") + ":", centerX, centerY - 83, -1);
