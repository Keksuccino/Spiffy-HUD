...
public class VisibilityRequirementsPopup extends FHPopup {
    ...
    public static class Requirement extends GuiComponent {
        ...
        public void render(PoseStack matrix, int mouseX, int mouseY, Screen renderIn) {
            ...
            drawCenteredString(matrix, Minecraft.getInstance().font, Locals.localize("spiffyhud.helper.creator.items.visibilityrequirements.requirement") + ":", centerX, centerY - 83, -1);
