...
import de.keksuccino.spiffyhud.customization.helper.ui.screens.FHConfigScreen;
...
public class MenuBar extends UIBase {
	...
	public static final ResourceLocation FH_LOGO_TEXTURE = new ResourceLocation("spiffyhud", "fh_pixel_logo.png");
	public static final ResourceLocation SHRINK_BTN_TEXTURE = new ResourceLocation("spiffyhud", "shrink_btn.png");
	public static final ResourceLocation EXPAND_BTN_TEXTURE = new ResourceLocation("spiffyhud", "expand_btn.png");
	...
	public MenuBar() {
		...
		fhBtn.setDescription(StringUtils.splitLines(Locals.localize("spiffyhud.config"), "%n%"));
		...
		AdvancedButton expandBtn = new AdvancedImageButton(0, 0, 20, 20, SHRINK_BTN_TEXTURE, true, (press) -> {
			...
			if (this.expanded) {
				...
				((AdvancedButton)press).setDescription(Locals.localize("spiffyhud.helper.menubar.shrink"));
			} else {
				((AdvancedImageButton)press).setImage(EXPAND_BTN_TEXTURE);
				((AdvancedButton)press).setDescription(Locals.localize("spiffyhud.helper.menubar.expand"));
			}
		}) {
			@Override
			public void render(PoseStack matrix, int mouseX, int mouseY, float partialTicks) {
		...
		expandBtn.setDescription(Locals.localize("spiffyhud.helper.menubar.shrink"));
