...
public class MenuBar extends UIBase {
	...
	public static final Identifier FH_LOGO_TEXTURE = new Identifier("spiffyhud", "fh_pixel_logo.png");
	public static final Identifier SHRINK_BTN_TEXTURE = new Identifier("spiffyhud", "shrink_btn.png");
	public static final Identifier EXPAND_BTN_TEXTURE = new Identifier("spiffyhud", "expand_btn.png");
