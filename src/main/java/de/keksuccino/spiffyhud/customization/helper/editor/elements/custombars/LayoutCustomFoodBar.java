...
import de.keksuccino.spiffyhud.customization.items.custombars.CustomFoodBarCustomizationItem;
...
public class LayoutCustomFoodBar extends LayoutCustomBarBase {
	...
	public void init() {
		...
		/** MAX FOOD **/
		AdvancedButton maxFoodButton = new AdvancedButton(0, 0, 0, 16, Locals.localize("spiffyhud.helper.creator.add.customfoodbar.maxfood"), true, (press) -> {
			FHTextInputPopup pop = new FHTextInputPopup(new Color(0, 0, 0, 0), Locals.localize("spiffyhud.helper.creator.add.customfoodbar.maxfood"), CharacterFilter.getIntegerCharacterFiler(), 240, (call) -> {
				if (call != null) {
