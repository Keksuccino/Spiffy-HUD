...
public class VanillaCustomizationItem extends CustomizationItemBase {
	...
	public VanillaCustomizationItem(@Nonnull IngameHudElement element, String elementDisplayName, @Nonnull PropertiesSection props, boolean isSecondItemOfThisType) {
		super(props);
