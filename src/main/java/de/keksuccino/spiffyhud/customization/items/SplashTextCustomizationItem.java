...
public class SplashTextCustomizationItem extends CustomizationItemBase {
	...
	public void render(MatrixStack matrix) {
		...
		if (this.shouldRender()) {
			...
			this.renderSplash(matrix, MinecraftClient.getInstance().textRenderer);
			
		}
		
	}

	protected void renderSplash(MatrixStack matrix, TextRenderer font) {
	...
	//TODO completely remove this or tweak it for HUD?
//	@SubscribeEvent
