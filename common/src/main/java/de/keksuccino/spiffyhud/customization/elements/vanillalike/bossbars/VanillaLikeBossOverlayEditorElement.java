...
public class VanillaLikeBossOverlayEditorElement extends AbstractEditorElement {

    public VanillaLikeBossOverlayEditorElement(@NotNull AbstractElement element, @NotNull LayoutEditorScreen editor) {
