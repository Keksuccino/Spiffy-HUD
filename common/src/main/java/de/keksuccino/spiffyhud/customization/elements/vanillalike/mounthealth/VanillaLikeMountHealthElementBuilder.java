...
public class VanillaLikeMountHealthElementBuilder extends ElementBuilder<VanillaLikeMountHealthElement, VanillaLikeMountHealthEditorElement> {
    ...
    @Override
    public @Nullable VanillaLikeMountHealthElement deserializeElementInternal(@NotNull SerializedElement serialized) {
        VanillaLikeMountHealthElement e = super.deserializeElementInternal(serialized);
        if (e != null) {
    ...
    public @NotNull Component getDisplayName(@Nullable AbstractElement element) {
        return Components.translatable("spiffyhud.elements.vanillalike.mount_health");
    }
