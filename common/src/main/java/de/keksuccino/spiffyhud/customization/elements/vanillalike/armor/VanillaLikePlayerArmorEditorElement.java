...
public class VanillaLikePlayerArmorEditorElement extends AbstractEditorElement {

    public VanillaLikePlayerArmorEditorElement(@NotNull AbstractElement element, @NotNull LayoutEditorScreen editor) {
